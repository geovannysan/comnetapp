...
export function OpcionesView(props: any) {
    ...
    return (
        <>
            ...
            {opction == "Perfil" ? <div className='container-fluid px-0  d-flex  justify-content-center'>
                        ...
                        <div className="cardt cardt-dark ">
                            ...
                            <div className="row">
                                ...
                                <div className=" col-4 col-md-6 text-center ">
                                    <p className="card__apply ">
                                        <a className="card__link" onClick={() => history.push("/page/perfil")}>Perfil  <i className="card_icon px-2  bi  bi-pencil"></i></a>
                                    </p>
                                </div>
                            </div>
